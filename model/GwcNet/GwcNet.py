...
from .cost_volume import concat_volume, Gwc_volume
...
class GwcNet(nn.Module):
    ...
    def forward(self, imgL, imgR, min_disp, max_disp):
        ...
        cost_vol = Gwc_volume(featureL, featureR, min_disp, max_disp, groups=self.groups) # shape -> B * groups * (maxdisp-mindisp)/4 * H/4 * W/4
        # cost filtering
