...
def evaluation(net, dataset_name, root, device, min_disp, max_disp, batch_size=1, resize=[1024, 1024], mode='testing'):
    ...
    test_loader = fetch_dataset(dataset_name = dataset_name, root = root,
                        ...
                        min_disp = min_disp, max_disp = max_disp, mode = mode, shuffle=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='testing', help='training, validating, testing')
    ...
    metric= evaluation(net, args.dataset_name, args.root, device, args.min_disp, args.max_disp, mode=args.mode)
